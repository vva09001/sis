// kiểm tra quản lý phương tiện trợ giúp
...
class Help extends Component {
  ...
  render() {
    ...
    return (
      <Layout
        title={t(
          'Quyền lợi hưởng BHXH – Phương tiện trợ giúp sinh hoạt, dụng cụ chỉnh hình sau tai nạn lao động, bệnh nghề nghiệp'
        )}
        ...
        <div className="cardInfo">
          ...
          <div className="form">
            ...
            <div>
              <p>
                {t(
                  'Ngày ra chỉ định của cơ sở chỉnh hình và phục hồi chức năng thuộc ngành Lao động – Thương binh và Xã hội hoặc của bệnh viện cấp tỉnh và tương đương trở lên, việc bạn đủ điều kiện được nhận quyền lợi cấp dụng cụ trợ giúp sinh hoạt, chỉnh hình'
                )}
              </p>
              <ButtonDate
