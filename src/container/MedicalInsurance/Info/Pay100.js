...
class Pay100 extends Component {
  render() {
    const { t } = this.props;
    return (
      <Layout
      ...
      >
        <div className="cardInfo">
          ...
          <div className="btn-submit">
            <IonButton>
              <p>
                {t('Nếu bạn thuộc trường hợp trên, BHYT')}
                <br />
                {t('thanh toán 100% cho bạn với số tiền là')}
              </p>
            </IonButton>
          </div>
          ...
          <div className="btn-submit">
            <IonButton>
              <p>
                {t('Nếu bạn thỏa mãn các điều kiện nêu trên')}
                <br />
                {t('BHYT thanh toán 100% cho bạn  với số tiền là')}
              </p>
            </IonButton>
          </div>
          <p className="text-blue text-bold">
...
export default withTranslation()(Pay100);
