...
class Pay100District extends Component {
  render() {
    const { t } = this.props;
    return (
      <Layout
          ...
          <div className="btn-submit">
            <IonButton>
              <p>
                ...
                <br />
                {t('trái tuyến, vượt tuyến tại bệnh viện Huyện là')}
              </p>
            </IonButton>
          </div>
          ...
          <div className="btn-submit">
            <IonButton>
              <p>
                ...
                <br />
                {t('vượt tuyến tại bệnh viện Huyện là')}
              </p>
            </IonButton>
          </div>
          <p className="text-blue text-bold">
...
Pay100District.propTypes = {
  t: PropTypes.func
};
export default withTranslation()(Pay100District);
